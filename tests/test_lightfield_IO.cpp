...
void test_lightfield_IO::test_IO_Pipeline_4D()
{
    ...
    // result gt container
    OpenLF::image::ImageChannel result_4D_wide(448,240);
    OpenLF::image::ImageChannel result_4D_high(240,448);
    ...
    CPPUNIT_ASSERT(result_4D_high.sum()==0.0);
    channels.clear();
    channels_gt.clear();
    properties.clear();
    ...
    CPPUNIT_ASSERT(result_4D_wide.sum()==0.0);
    channels.clear();
    channels_gt.clear();
    properties.clear();
...
void test_lightfield_IO::test_IO_Pipeline_3DH() 
{
    ...
    // result gt container
    OpenLF::image::ImageChannel result_3DH_wide(448,48);
    OpenLF::image::ImageChannel result_3DH_high(240,64);
    ...
    CPPUNIT_ASSERT(result_3DH_high.sum()==0.0);
    channels.clear();
    channels_gt.clear();
    ...
    CPPUNIT_ASSERT(result_3DH_wide.sum()==0.0);
    channels.clear();
    channels_gt.clear();
...
void test_lightfield_IO::test_IO_Pipeline_3DV() 
{
    ...
    // result gt container
    OpenLF::image::ImageChannel result_3DV_wide(vigra::Shape2(240,64));
    OpenLF::image::ImageChannel result_3DV_high(vigra::Shape2(448,48));
    ...
    CPPUNIT_ASSERT(result_3DV_high.sum()==0.0);
    channels.clear();
    channels_gt.clear();
    ...
    CPPUNIT_ASSERT(result_3DV_wide.sum()==0.0);
    channels.clear();
    channels_gt.clear();
...
void test_lightfield_IO::test_IO_Pipeline_CROSS() 
{
    ...
    // result gt container
    OpenLF::image::ImageChannel result_CROSS_wide(vigra::Shape2(448,112));
    OpenLF::image::ImageChannel result_CROSS_high(vigra::Shape2(448,112));
    ...
    CPPUNIT_ASSERT(result_CROSS_high.sum()==0.0);
    channels.clear();
    channels_gt.clear();
    ...
    CPPUNIT_ASSERT(result_CROSS_wide.sum()==0.0);
    channels.clear();
    channels_gt.clear();
